...
const App: React.FC = () => {
  ...
  return (<div>
    ...
    <Tokenomics
      ...
      <Ticker/>
      <WhyChooseUs
      leftImage="/13.png" // Caminho para a imagem à esquerda
      rightImage="/15.png" // Caminho para a imagem à direita
